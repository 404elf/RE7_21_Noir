param([string]$OutputRoot = 'dist/v1.4.4')
...
foreach ($name in @('AI-v1.4.1.md','ai-v141-calibrated-benchmark.jsonl','AI-v1.4.2.md','AI-v1.4.3.md','AI-v1.4.4.md','ai-v142-release-benchmark.jsonl','ai-v144-weight-trial.jsonl','ai-v144-final-benchmark.json')) {
